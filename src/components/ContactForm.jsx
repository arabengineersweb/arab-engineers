    ...
    <section id="contact" className="pt-32 py-12 relative overflow-hidden" style={{backgroundColor: 'white'}}>
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          {/* Contact Info */}
          <div data-aos="fade-right" className="space-y-6 lg:space-y-8 w-full">
            <div className="bg-white p-6 lg:p-8 rounded-2xl shadow-lg w-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-3 lg:gap-4">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{backgroundColor: primary}}>
                ...
                <div className="flex items-start gap-3 lg:gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-gray-600 break-words" style={{fontSize: 'var(--text-size)'}}>{contact.address}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Contact Form */}
          <div data-aos="fade-left" className="bg-white p-6 lg:p-8 rounded-2xl shadow-lg w-full">
            <h4 className="text-2xl font-semibold mb-6" style={{color: primary}}>
