  ...
  return (
    <section id="contact" className="pt-32 py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-10 left-10 w-72 h-72 rounded-full opacity-5" style={{backgroundColor: '#004C97'}}></div>
        <div className="absolute bottom-10 right-10 w-96 h-96 rounded-full opacity-5" style={{backgroundColor: '#004C97'}}></div>
      </div>
      
      <div className="relative max-w-7xl mx-auto px-6">
        {/* Header */}
        <div className="text-center mb-16" data-aos="fade-up">
          <h3 className="text-4xl lg:text-5xl font-bold mb-6" style={{color: '#004C97'}}>
            {contact.title}
          </h3>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div data-aos="fade-right" className="space-y-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <h4 className="text-2xl font-semibold mb-6" style={{color: '#004C97'}}>
                {lang === 'en' ? 'Get in Touch' : 'تواصل معنا'}
              </h4>
              
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{backgroundColor: '#004C97'}}>
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <h5 className="font-semibold text-gray-900 mb-1 text-base">{lang === 'en' ? 'Email' : 'البريد الإلكتروني'}</h5>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="font-semibold text-gray-900 mb-1 text-base">{lang === 'en' ? 'Phone' : 'الهاتف'}</h5>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="font-semibold text-gray-900 mb-1 text-base">{lang === 'en' ? 'Address' : 'العنوان'}</h5>
                    <p className="text-gray-600 text-base">{contact.address}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Additional info */}
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <h4 className="text-xl font-semibold mb-4" style={{color: '#004C97'}}>
              ...
              <ul className="space-y-3 text-gray-600 text-base">
                {(contact.whyChooseUs?.benefits || []).map((benefit, index) => (
                  <li key={index} className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full" style={{backgroundColor: '#004C97'}}></div>
                    {benefit}
                  </li>
                ))}
              </ul>
